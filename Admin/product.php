...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    // For deleting the product from the database.
    if ($type == 'delete') {
        $id = get_safe_value($con, $_GET['id']);
...
// Using a join to get the products and corresponding category
                    ...
                    <div class="card-body--">
                        <div class="table-stats order-table ov-h">
                            <table class="table ">
                                <thead>
                                    <tr>
                                        <!-- Can add a toggler in the future -->
                                        <th class="serial">#</th>
                                        <th>ID</th>
                                        <th>Categories</th>
                                        <th>Name</th>
                                        ...
                                        <th>Price</th>
                                        <th>Qty</th>
                                        <th></th> <!-- For different options to do like active, deactive and delete -->
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
