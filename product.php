...
$getproducts = get_product_details($con, $product_id);
?>
...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url('images/bg/4.jpg') no-repeat scroll center center / cover !important;">
                ...
                <div class="col-xs-12">
                    <div class="bradcaump__inner">
                        <nav class="bradcaump-inner">
                            <a class="breadcrumb-item products" href="index.html">Home</a>
                            <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                            <span class="breadcrumb-item products active">Products</span>
                        </nav>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="shop__grid__view__wrap">
                                <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane fade in active clearfix">
                                    <?php foreach ($getproducts as $list) { ?>
                                            ...
                                            <div class="category">
                                                <div class="ht__cat__thumb">
                                                    <a href="product-details.html">
                                                        <img src="<?php echo PRODUCT_IMAGE_SERVER_PATH . $list['image']; ?>" class="img-height" alt="product images">
                                                    </a>
                                                </div>
                                            ...
                                            foreach ($getproducts as $list) { ?>
                                                ...
                                                <div class="ht__list__product">
                                                    <div class="ht__list__thumb">
                                                        <a href="product-details.html"><img src="<?php echo PRODUCT_IMAGE_SERVER_PATH . $list['image']; ?> " class="img-height"></a>
                                                    </div>
